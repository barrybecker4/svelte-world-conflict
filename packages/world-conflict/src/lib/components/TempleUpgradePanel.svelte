<script lang="ts">
    ...
    import {
        TEMPLE_UPGRADES_BY_NAME,
        type TempleUpgradeDefinition
    } from '$lib/game/constants/templeUpgradeDefinitions';
    ...
    $: templeInfo = temple?.getDisplayInfo() || {
        name: 'Basic Temple',
            ...
            for (const upgrade of templeUpgrades) {
                ...
                options.push({
                    ...
                    description: upgrade.description
                        .replace('{level}', 'Temple')
                        .replace('{value}', upgrade.level[0].toString())
                });
            }
        }
    ...
    <Panel variant="glass" padding={false} customClass="game-info-panel">
        ...
        <Section title="">
            <div class="stat-display">
                ...
                <div class="stat-item">
                    <div class="stat-value">
                        {currentFaith} <span class="symbol">{@html SYMBOLS.FAITH}</span>
                    </div>
        ...
        <!-- Done Button -->
        <Section title="">
            <Button variant="secondary" size="lg" uppercase onclick={handleDone}>Done</Button>
        </Section>
    </Panel>
</div>
