    ...
    <div class="waiting-room-container" data-testid="waiting-room">
            ...
            {#if game}
                ...
                <div class="status-section">
                    {#if openSlotsCount > 0}
                        ...
                        <p class="help-text">
                            Share this game ID with friends: <strong>{gameId}</strong>
                        </p>
                    {:else}
                        <p class="waiting-text ready">🚀 Starting game...</p>
                    {/if}
        ...
        {#if showAds}
            <div class="ad-container">
                <AdBanner {adUnitId} adFormat="rectangle" className="waiting-room-ad" />
            </div>
        {/if}
    </div>
</div>
