        ...
        {:else}
            <div class="lobby-container">
                <div class="lobby-header">
                    <h1>
                        Select Game (or configure new one)
                        <br />
                ...
                <div class="bottom-box">
                    <Button
                        ...
                        data-tooltip="Create a new game if none of the above are to your liking"
                    >
                        Configure New Game
                    </Button>
                    <Button variant="ghost" size="lg" onclick={close} data-testid="lobby-back-btn">Back</Button>
                </div>
            </div>
        {/if}
    </div>
