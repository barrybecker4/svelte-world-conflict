...
export class BattleReplayCoordinator {
    ...
    private async playFullBattleAnimation(move: DetectedMove, regions: any[]): Promise<void> {
        ...
        await this.playBattleSequenceWithEffects(move.attackSequence!, regions, sourceRegion, targetRegion);
     ...
     */
    private isConquestSuccessful(finalGameState: any, sourceRegion: number, targetRegion: number): boolean {
