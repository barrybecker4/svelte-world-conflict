...
test.describe('Multi-Game Concurrent Tests', () => {
  ...
  test('Test: Three Simultaneous 4-Player Games', async ({ browser }) => {
    ...
    const contexts = await Promise.all(
      Array.from({ length: 12 }, () => browser.newContext())
    );
    ...
    const games = [
      { pages: game1Pages, name: 'Game 1', gameId: '', players: ['G1P1', 'G1P2', 'G1P3', 'G1P4'] },
      { pages: game2Pages, name: 'Game 2', gameId: '', players: ['G2P1', 'G2P2', 'G2P3', 'G2P4'] },
      { pages: game3Pages, name: 'Game 3', gameId: '', players: ['G3P1', 'G3P2', 'G3P3', 'G3P4'] },
    ];
